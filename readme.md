...
1. **Clone the repository:**
    ...
    ```sh
    git clone https://github.com/NIKOLENKO-TE/mail.GuerrillaMailApi.git
    ```

2. **Navigate to the project directory:**

    ```sh
    cd mail.GuerrillaMailApi
    ```
...
public class Main {
    public static void main(String[] args) {
        String emailAddress = mail.GuerrillaMailApi.getRandomEmailAddress();
...
public class Main {
    public static void main(String[] args) {
        String emailAddress = mail.GuerrillaMailApi.getRandomEmailAddress();
        mail.GuerrillaMailApi.readFromRandomEmail(emailAddress, 1, 5, 20, "stop@email.com", false);
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        String content = mail.GuerrillaMailApi.getEmailContent(mailId);
...
public class Main {
    public static void main(String[] args) {
        ...
        mail.GuerrillaMailApi.deleteEmail(mail.GuerrillaMailApi.getEmailId(emailToDelete), emailToDelete);
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        mail.GuerrillaMailApi.deleteAllEmails("portishead@guerrillamailblock.com");
    }
}
```
...
public void createRandomAccount() {
    String randomEmailAddress = mail.GuerrillaMailApi.getRandomEmailAddress();
    System.out.println("Generated Random Email: " + randomEmailAddress);
    mail.GuerrillaMailApi.readFromRandomEmail(randomEmailAddress, 1, 2, 10, "stop@email.com", false);
}
```
...
public void createNewAccount() {
    ...
    mail.GuerrillaMailApi.readFromIndividualEmail(specificEmailAddress, 1, 2, 10, "stop@email.com", false);
}
```
...
public void deleteAllEmailsOnAccount() {
    mail.GuerrillaMailApi.deleteAllEmails("portishead9@guerrillamailblock.com");
}
```
...
```json
{
  "email_addr":"mail.GuerrillaMailApi@guerrillamailblock.com",
...
**Example Request:**
```
https://api.guerrillamail.com/ajax.php?f=set_email_user&email_user=mail.GuerrillaMailApi&site=guerrillamail.com&lang=en&sid_token=lmmb0hfqa6qjoduvr2vdenas62
```
...
```json
{
  ...
  "count":"1",
  "email":"mail.GuerrillaMailApi@guerrillamailblock.com",
...
```json
{
  "mail_id":"23518264",
  "mail_from":"bounce1@worldlargestsafelist.com",
  "mail_recipient":"mail.GuerrillaMailApi@guerrillamailblock.com",
  "mail_subject":"MULTIPLY Your Traffic, Leads & Subscribers to INFINITY!",
  "mail_excerpt":"Aloha from beautiful Hawai`i ...",
...
**Example Request:**
```
https://api.guerrillamail.com/ajax.php?f=forget_me&email_addr=mail.GuerrillaMailApi@guerrillamailblock.com&sid_token=lmmb0hfqa6qjoduvr2vdenas62
```
...
```json
{
  "list":[
    {
      "mail_id":"23456789",
      "mail_from":"mail.GuerrillaMailApi@example.com",
